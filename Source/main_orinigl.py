...
import time
import math
from dataloader import KITTIloader2015 as kl
...
all_left_img, all_right_img, all_left_disp, test_left_img, test_right_img, test_left_disp = kl.dataloader(args.datapath)
